// 3-digit zip prefix ranges → state abbreviation
const zipRanges: [number, number, string][] = [
  [5, 9, 'NY'], [10, 27, 'MA'], [28, 29, 'RI'], [30, 38, 'NH'], [39, 49, 'ME'],
  ...
  [370, 385, 'TN'], [386, 397, 'MS'], [400, 427, 'KY'], [430, 459, 'OH'], [460, 479, 'IN'],
  ...
  [870, 884, 'NM'], [889, 898, 'NV'], [900, 966, 'CA'], [967, 968, 'HI'], [970, 979, 'OR'],
...
export function zipToState(zip: string): string | null {
  ...
  for (const [lo, hi, abbr] of zipRanges) {
    if (prefix >= lo && prefix <= hi) return abbr;
  }
  return null;
}

export const stateAbbrevToSlug: Record<string, string> = {
